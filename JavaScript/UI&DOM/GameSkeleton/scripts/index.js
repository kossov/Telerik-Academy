...
var fieldWidth = 54, // pixels
    boardSide = 324, // left or right side of the board in pixels
    ...
    var gameboard = {
        init: function () {
            ...
            for (var i = 0; i < 24; i += 1) {
                if (i === 0 || i === 23) {  // must put 2 checkers; on 0-whites, 23-blacks

                } else if (i === 5 || i === 11 || i === 12 || i === 18) {
...
function newGame() {
    ...
    canvas.addEventListener('click', findClickedField);

    init();

    function findClickedField(event) {
        var x = event.offsetX;
        var y = event.offsetY;
        var i = 0,
            len,
        ...
        if (x < boardSide && x > boardFrameOffset) { // left side of the board
            if (i === 0) { // bottom left side
                i = 6;
            } else { // upper left side
                i = 12;
            }
        } else if (x > boardSide + boardBar && x < canvas.width - boardFrameOffset) { // right side of the board
