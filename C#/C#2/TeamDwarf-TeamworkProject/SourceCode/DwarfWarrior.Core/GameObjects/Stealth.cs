namespace DwarfWarrior.Core.GameObjects
{
    ...
    public class Stealth : Spaceship, IRenderable, IMovable, ICollidable, IShootable
    {
        ...
        public Stealth(Coordinate topLeftPosition, Coordinate speed, string collisionGroupString, char[,] body)
